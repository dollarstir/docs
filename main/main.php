                        ...
                        <li x-data="{ expanded: false }" class="relative" @keydown.window.escape="expanded = false">
                            <button class="flex items-center justify-center" @click="expanded = !expanded">
                                ...
                                <span class="ml-3 shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" :class="{ 'rotate-180': expanded }"
                            ...
                            <div x-show="expanded" x-cloak
                                ...
                                <div class="mt-4 w-224 p-8 bg-white shadow-lg transform transition-transform origin-top"
                                        ...
                                        <li>
                                            <a href="docs/9.x/starter-kits.html#laravel-breeze" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Lightweight starter kit
                                                        scaffolding for new applications with Blade or Inertia.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="docs/9.x/billing.html" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Take the pain out of managing
                                                        subscriptions on Stripe or Paddle.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="docs/9.x/dusk.html" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Automated browser testing to
                                                        ship your application with confidence.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="docs/9.x/broadcasting.html" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Listen for WebSocket events
                                                        broadcast by your Laravel application.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://envoyer.io" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Deploy your Laravel applications
                                                        to customers with zero downtime.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://forge.laravel.com" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Server management doesn't have
                                                        to be a nightmare.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="docs/9.x/horizon.html" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Beautiful UI for monitoring your
                                                        Redis driven Laravel queues.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://jetstream.laravel.com" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Robust starter kit including
                                                        authentication and team management.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="docs/9.x/mix.html" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Compile your JavaScript and CSS
                                                        using Webpack with zero configuration.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://nova.laravel.com/" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Thoughtfully designed
                                                        administration panel for your Laravel applications.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="docs/9.x/octane.html" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Supercharge your application's
                                                        performance by keeping it in memory.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="docs/9.x/sail.html" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-xs text-g7ay-600">Hand-crafted Laravel local
                                                        development experience using Docker.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="docs/9.x/sanctum.html" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-xs te7t-gray-600">API and mobile application
                                                        authentication without wanting to pull your hair out.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="docs/9.x/scout.html" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Lightning fast full-text search
                                                        for your application's Eloquent models.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="docs/9.x/socialite.html" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Social authentication via
                                                        Facebook, Twitter, GitHub, LinkedIn, and more.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://spark.laravel.com" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Launch your next business with
                                                        our fully-featured, drop-in billing portal.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="docs/9.x/telescope.html" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Debug your application using our
                                                        debugging and insight UI.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="docs/9.x/valet.html" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">The fastest Laravel local
                                                        development experience - exclusively for macOS.</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://vapor.laravel.com" class="flex">
                                                ...
                                                <div class="ml-4 leading-5">
                                                    ...
                                                    <span class="text-gray-700 text-xs">Laravel Vapor is a serverless
                                                        deployment platform for Laravel, powered by AWS.</span>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
